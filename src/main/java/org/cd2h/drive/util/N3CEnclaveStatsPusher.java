...
public class N3CEnclaveStatsPusher extends Sheet {
	...
	prop_file = PropertyLoader.loadProperties("gsuite_enclave_stats");
	conn = getConnection();
	...
	PreparedStatement stmt = conn.prepareStatement("select * from n3c_admin.enclave_stats");
