...
create view drive.person_staging as
select 
...
union
    ...
    from (select email_address,phase_ii_projects__data_harmonization_ as role from drive.person) as foo
    where role is not null and role != 'Not involved'
union
...
truncate google.person;
truncate google.role;
